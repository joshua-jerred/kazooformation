...
class K2PeakModel {
   ...
   private:
    ...
    Token detectSymbolFromFftResults(const Fft::FftResults& results) const {
      ...
      const double average_working_power =
          (sym_0_poi_power + sym_1_poi_power + sym_2_poi_power + sym_3_poi_power) / 4.0;
 ...
 private:
  ...
  static constexpr std::array<double, NUM_PEAKS_OF_INTEREST> SYM_A_00_PEAKS_OF_INTEREST{
      1080.0, 2201.0, 3080.0};
  static constexpr std::array<double, NUM_PEAKS_OF_INTEREST> SYM_D_01_PEAKS_OF_INTEREST{
      880.0, 2040, 3802};
  static constexpr std::array<double, NUM_PEAKS_OF_INTEREST> SYM_E_10_PEAKS_OF_INTEREST{
      1161.0, 1481.0, 1961.0};
  static constexpr std::array<double, NUM_PEAKS_OF_INTEREST> SYM_G_11_PEAKS_OF_INTEREST{
      1160.0, 2921.0, 3121.0};
};
